...
export const articles: DocArticle[] = [
  ...
  {
    "id": "circuit-breaker-retry-backoff",
    "category": "STREAMING & ISOLATION",
    "title": "Outbound Resilience: Circuit Breaker & Retry-Backoff",
    "subtitle": "Wyre provides native resilience tools for outbound network calls (such as queries to LLM providers or remote databases/v...",
    "description": "Wyre technical guide for Outbound Resilience: Circuit Breaker & Retry-Backoff.",
    "headings": [
      {
        "id": "the-need-for-outbound-resilience-in-agentic-systems",
        "label": "The Need for Outbound Resilience in Agentic Systems"
      },
      {
